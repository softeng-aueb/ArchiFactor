...
public class ServiceMethodProviderFactory {
	...
	public static ServiceMethodProvider createProvider(RelationshipInfo relationship, SystemObject systemObject) {
		...
		if (relationshipType == JpaRelationshipType.MANY_TO_ONE) {
			...
			return OneToManyServiceMethodProvider.fromRelationship(relationship, systemObject);
			...
			if (relationship.isOwningSide()) {
				...
				return ManyToManyNonOwningServiceMethodProvider.fromRelationship(relationship, systemObject);
			}
		}
		return null;
	}
